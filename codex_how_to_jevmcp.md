<!-- Generated by the maintainers' scripts/build_howto.py from the shipped plugin, jevmcp 1.7.2.
     Verbatim sources:
       plugins/jevmcp/skills/spec-drift/SKILL.md (sha256 a67def822b7d3d77...),
       ...
       plugins/jevmcp/scripts/jevmcp_server.py (INSTRUCTIONS and TOOLS; sha256 f59256fcd27a3c1f...).
...
- `spec-drift`: `a67def822b7d3d771eb84d88ea24e739bf41297bf9070e11777327eb6a551d75`
...
| 3 | Each skill's body — the procedure | spec-drift 14.1 kB, ci-triage 10.2 kB, code-audit 10.8 kB | only when that skill fires |
...
### 3.1 `spec-drift` — `plugins/jevmcp/skills/spec-drift/SKILL.md` (sha256 `a67def822b7d3d77...`, 14,947 bytes)
